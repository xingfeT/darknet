...
batchnorm_layer* make_batchnorm_layer(int batch, int w, int h, int c){
    ...
    batchnorm_layer* l = new batchnorm_layer();
...
void batchnorm_layer::resize( int w, int h){
    fprintf(stderr, "Not implemented\n");
}

void batchnorm_layer::forward(network net){
  batchnorm_layer* l = this;
...
void batchnorm_layer::backward(network net){
  batchnorm_layer* l = this;
  if(!net.train){
