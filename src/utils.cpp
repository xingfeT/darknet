...
void sorta_shuffle(void *arr1, size_t n, size_t size, size_t sections){
  char * arr = (char*)arr1;
  size_t i;
...
void shuffle(void *arr1, size_t n, size_t size){
    char * arr = (char*)arr1;
  size_t i;
